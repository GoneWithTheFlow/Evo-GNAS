...
# Mark unused gene units before code generation.
def optim_gene_code(gene_units_params):
    ...
    def mark_used(pos):
        """Recursively mark the given position and all of its input units as used."""
...
# Write generated model code to a Python module.
