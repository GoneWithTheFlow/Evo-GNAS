...
data_path = r"C:\Users\XinLiu\Desktop\QUBO\data\G22.txt"
...
class GEN_GNN_MODEL(torch.nn.Module):
    def __init__(self):
        ...
        self.gnn_2 = GCNConv(in_channels=64, out_channels=25)
        self.gnn_3 = GCNConv(in_channels=25, out_channels=64)
        self.gnn_6 = GCNConv(in_channels=64, out_channels=64)
        self.gnn_8 = GCNConv(in_channels=128, out_channels=1)

    def forward(self, x_0, edge_index):
        x_2 = F.leaky_relu(self.gnn_2(x_0, edge_index))
        ...
        x_6 = F.relu(self.gnn_6(x_3, edge_index))
        x_6 = F.dropout(x_6, p=0.4, training=self.training)
        x_7 = torch.cat([x_6, x_3], dim=1)
        x_8 = self.gnn_8(x_7, edge_index)
