...
data_path = r"C:\Users\XinLiu\Desktop\QUBO\data\G14.txt"
...
class GEN_GNN_MODEL(torch.nn.Module):
    def __init__(self):
        ...
        self.gnn_1 = ARMAConv(in_channels=64, out_channels=45, num_stacks=2, num_layers=2, dropout=0.4)
        self.gnn_6 = nn.Identity()
        self.gnn_7 = GCNConv(in_channels=45, out_channels=1)

    def forward(self, x_0, edge_index):
        x_1 = self.gnn_1(x_0, edge_index)
        x_1 = F.dropout(x_1, p=0.4, training=self.training)
        x_6 = F.elu(self.gnn_6(x_1))
        x_6 = F.dropout(x_6, p=0.5, training=self.training)
        x_7 = self.gnn_7(x_6, edge_index)
        return torch.sigmoid(x_7)
