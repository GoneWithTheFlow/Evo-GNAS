...
# Create and wait for differentiable-search tasks.
...
# Wait until all differentiable-search workers finish.
...
# Insert differentiable-search tasks into the database.
...
# Filter out gene subspaces that have already been searched.
...
# Build gene subspaces from scored individuals in one iteration.
...
# Convert a gene into a differentiable-search space descriptor.
...
# Simplify a gene before building its search-space descriptor.
...
# Remove unused gene units from a gene string.
...
# Build an adjacency matrix and parameter list from a gene.
...
# Remove unused nodes from an adjacency matrix and parameter list.
...
# Sort matrix nodes into a canonical structural order.
...
# Convert a canonical matrix and parameters back into a gene.
