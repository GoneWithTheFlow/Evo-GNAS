...
final_model_dirname, best_mis_size, acc, runtime = gnn_trainer.train(
...
with Session(engine) as session:
    ...
    session.execute("insert into acc (id, accuracy, mis_size) values ("+str(id)+", "+str(acc)+", "+str(best_mis_size)+")")
